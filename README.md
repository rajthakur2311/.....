...
Key Features
Coupled Optical–Thermal Pipeline: Automatically maps 3D optical fluence rate distributions $\Phi(x,y,z)$ from GPU-accelerated Monte Carlo simulations directly into volumetric heat generation matrices $Q_{\text{laser}}(x,y,z)$.
...
The MATLAB code is available within this repo, which runs for all different optical sources.
